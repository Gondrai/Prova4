...
type Msg = Input1 String | Input2 String | AreaParalelogramo
...
update msg model =
  case msg of
    ...
    AreaParalelogramo -> {model | resultado = ((model.i1) * (model.i2))}
                
buttonStyle : List (Attribute msg) 
buttonStyle = [ style "color" "#ffffff" , style "width" "150px" , style "font-weight" "bold" , style "font-size" ""]
...
view model =
  div [style "background-color" "#66CDAA", style "padding" "10% 10%" ][
    div [style "padding" "12% 30%", style "margin" "50px", style "background-color" "#123e3b" ]
        [ h1 [style "color" "#bf2f80"] [text "Calcular área Paralelogramo"]
        , div []
        [p []
        ...
        , p [][
        button [onClick AreaParalelogramo] [text "Calcular"]]
        , div []
        [text "A área do Paralelogramo é:"
        ] , div []
